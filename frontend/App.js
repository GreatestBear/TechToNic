...
import UserInfoScreen_0 from './UserInfoScreen_0'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_1 from './UserInfoScreen_1'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_2 from './UserInfoScreen_2'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_3 from './UserInfoScreen_3'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_4 from './UserInfoScreen_4'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_5 from './UserInfoScreen_5'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_6 from './UserInfoScreen_6'; // 다음 화면 컴포넌트 이름을 지정하세요
import UserInfoScreen_fin from './UserInfoScreen_fin.js'; // 다음 화면 컴포넌트 이름을 지정하세요
